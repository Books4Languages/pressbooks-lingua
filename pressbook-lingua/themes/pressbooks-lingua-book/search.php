<?php get_header(); ?>
	...
	<div role="main">
		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); //if there are posts with the word digited?>
		<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
			<header>
				<h3><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); //article title?></a></h3>

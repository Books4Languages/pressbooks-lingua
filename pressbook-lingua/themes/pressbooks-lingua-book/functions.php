...
/**
 * Controls if the page info are empty or filled
 */
function are_page_information_fields_filled() {

	$pm_CM = Pressbooks_Metadata_Chapter_Metadata::get_instance();
	$pm_CM->are_chapter_metadata_fields_filled();

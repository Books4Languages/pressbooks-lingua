...
function _logo_url( $profile ) {
	...
	/* Set OUR catalog image */
	$img_path = get_bloginfo('template_directory').'/../themes/pressbooks-lingua-book/images/default-book-cover-100x100-catalog.jpg';
...
<div class="catalog-wrap">
	...
	<div id="catalog-sidebar" class="catalog-sidebar">
		...
		<div class="sidebar-inner-wrap">
			...
			<img class="catalog-logo" src="<?php echo _logo_url( $profile ); ?>" alt="catalog-logo" width="100" height="99" /> <!--src="<?php echo _logo_url( $profile ); ?>"-->
			</a>
			...
			<?php foreach ( $books as $b ) : ?>
				<div class="book-data mix<?php echo _tag_classes( $b ); ?>">
					...
					<div class="book">
						...
						<!--<img src="<?php echo get_bloginfo('template_directory');?>/../../../pressbook-lingua/themes/pressbooks-lingua-book/images/default-book-cover-225x0.jpg?>"alt="book-cover" width="225" height="<?php echo $b['cover_height']; ?>" /></a>-->
					</div><!-- end .book -->
